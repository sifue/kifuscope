...
赤い最終手ハイライトや黄色枠のような盤面内演出に対しては、テンプレート照合時に背景色そのものよりも駒文字・輪郭の局所コントラストを重く見るようにしています。毎フレームChatGPTなど外部画像認識へ送る方式は、遅延、費用、ネットワーク依存、配信中の再現性の面で通常運用には向きません。外部画像認識は、どうしてもテンプレートや軽量分類器で安定しない局面の調査・教師データ作成の補助として使う方針です。
